                ...
                <table class="formtable">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" value="100" name="meetingid"/>
                            <input type="hidden" value="8" name="reservationistid"/>
                            <input type="hidden" value="2022-02-02 00:00:00" name="reservationtime"/>
                            <input type="hidden" value="2022-02-02 00:00:00" name="canceledtime"/>
                            <input type="hidden" value="0" name="status"/>
                            <input type="hidden" value="hehe" name="canceledreason"/>
