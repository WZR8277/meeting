                            ...
                            <tr>
                                ...
                                <td>
                                    <#if mr.status==0>
                                        ...
                                        <input type="radio" id="status" name="status" value="1"/><label for="status" value="1">已启用</label>
                                    <#else>
                                        <input type="radio" id="status" name="status"  value="0"/><label for="status">启用</label>
                                        <input type="radio" id="status" name="status" checked="checked" value="1"/><label for="status" value="1">已启用</label>
                                    </#if>
